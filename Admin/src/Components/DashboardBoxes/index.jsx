    ...
    >
        <SwiperSlide>
            <div className='box bg-white p-5 cursor-pointer hover:bg-[#fafafa] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center gap-4'>
                ...
                <IoStatsChartSharp className='text-[50px] ml-auto text-[#3872fa]' />
            </div>
        </SwiperSlide>
         ...
         <SwiperSlide>
            <div className='box bg-white p-5 cursor-pointer hover:bg-[#fafafa] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center gap-4'>
                ...
                <IoStatsChartSharp className='text-[50px] ml-auto text-[#10b981]' />
            </div>
        </SwiperSlide>
         ...
         <SwiperSlide>
            <div className='box bg-white p-5 cursor-pointer hover:bg-[#fafafa] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center gap-4'>
                ...
                <IoStatsChartSharp className='text-[50px] ml-auto text-[#7928ca]' />
            </div>
        </SwiperSlide>
         ...
         <SwiperSlide>
            <div className='box bg-white p-5 cursor-pointer hover:bg-[#fafafa] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center gap-4'>
                ...
                <IoStatsChartSharp className='text-[50px] ml-auto text-[#312be1d8]' />
            </div>
        </SwiperSlide>
