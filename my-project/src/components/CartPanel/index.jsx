    ...
    <div className='scroll w-full max-h-[300px] overflow-y-scroll overflow-x-hidden py-3 px-4'>
          <div className='cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] pb-4'>
            <div className='img w-[25%] overflow-hidden h-[80px] rounded-md'>
              ...
              <img src="https://www.jiomart.com/images/product/original/rvt6wzx9ww/tazo-mens-round-neck-regular-fit-full-length-sleeve-t-shirt-t-shirt-for-mens-mens-t-shirt-mens-tshirt-tshirt-for-mens-t-shirts-tshirts-gym-wear-sports-wear-mens-tshirt-dryfit-t-shirts-product-images-rvt6wzx9ww-0-202404152348.jpg" alt="cartItem"
              className='w-full group-hover:scale-105' />
                </Link>
            </div>

            <div className='info w-[75%] pr-15 relative'>
              <h4 className='text-[14px] font-[500]'>
                <Link to="/product/1" className='link transition-all'>TAZO Mens Round Neck Round Neck</Link>
                </h4>
              ...
              <MdOutlineDeleteOutline className='absolute top-[10px] right-[10px] cursor-pointer link transition-all' />
            </div>
          </div>
